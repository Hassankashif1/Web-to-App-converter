...
function mainJsSource( { appName, websiteUrl, backgroundColor, preloaderEnabled, minDurationMs, offlineGameEnabled } ) {
...
async function buildDesktop( job ) {
	...
	await fsp.writeFile(
		...
		mainJsSource( { appName, websiteUrl, backgroundColor, preloaderEnabled, minDurationMs, offlineGameEnabled } )
	);
